...
if locale == "itIT" then
    L                     = L or {}
    L["%s: No confirmation"] = "%s: Non confermato"
    L["Bag sort confirmation popup:"] = "Popup di conferma ordinamento zaino:"
    L["Bags"]             = "Zaini"
    L["Bank button layout set to:"] = "Disposizione pulsanti della banca impostata su:"
    L["Bank button order set to:"] = "Ordine pulsanti della banca impostati su:"
    L["Bank columns set to:"] = "Colonne banca impostate su:"
    L["Bank scale set to: %0.2f"] = "Scala banca impostata su: %0.2f"
    L["BoA"]              = "BoA"
    L["BoE"]              = "BoE"
    L["Can't set number of columns to less than 8."] = "Non puoi impostare n. colonne sotto 8."
    L["Character specific settings"] = "Opzioni personaggio specifiche"
    ...
    L["Equipment set icon display:"] = "Mostra icone equipaggiamento:"
    L["Gap: %d columns"]  = "Spazio: %d colonne"
    L["Gap: %d rows"]     = "Spazio: %d righe"
    L["Inventory button layout set to:"] = "Disposizione pulsanti zaino impostata su:"
    L["Inventory button order set to:"] = "Ordine pulsanti zaino impostato su:"
    L["Inventory columns set to:"] = "Colonne zaino impostate su:"
    L["Inventory gaps set to: %s %s"] = "Spazio zaino impostata su: %s %s"
    L["Inventory scale set to: %0.2f"] = "Scala zaino impostata su: %0.2f"
    L["Inventory snap to default position:"] = "Posizione zaino predefinita:"
    L["No column gaps"]   = "No spazio colonne"
    L["No row gaps"]      = "No spazio righe"
    L["Pet"]              = "Mascotte"
    L["Reverse"]          = "Inversa"
